...
app.post('/signup',(req,res)=>{
  ...
  app.post('/usernameAndMailFinder',async(req,res)=>{
    try{
  ...
  app.post('/setmailotp',async function(req,res){
    try{
  ...
  app.post('/getProfileCaption',function(req,res){
    try{
  ...
  app.post('/otpValidation',function(req,res){
  ...
  app.post('/thoughtColl',async function(req,res){
  ...
  app.post('/thoughtsSender',function(req,res){
    blogUser.find({email:req.body.email}, 'thoughts', function(err, someValue){
      res.json(someValue)
    })
  })
  ...
  app.post('/sendRequests',function(req,res){
  ...
  app.post('/friendRequestsAnimToggle',function(req,res){
  ...
  app.post('/acceptFriendRequest',async function(req,res){
  ...
  app.post('/blogtweets',function(req,res){
  ...
  app.post('/uploadProfile',async function(req,res){
    try{
